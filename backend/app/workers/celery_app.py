...
celery_app = Celery(
    ...
    include=[
        ...
        "app.workers.tasks.pessoa_juridica",
        "app.workers.tasks.contratos",
        "app.workers.tasks.recursos_recebidos",
        "app.workers.tasks.acordos_leniencia",
        "app.workers.tasks.ceis",
        "app.workers.tasks.cnep",
        "app.workers.tasks.cepim",
